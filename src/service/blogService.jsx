...
const API_URL = import.meta.env.VITE_API_URL || 'https://bk-appstore.victor-door.com/api/v1/blog';
 ...
 getBlogs: async () => {
    try {
      const response = await axios.get(API_URL, {
        headers: authService.getAuthHeader?.() || {}, // optional auth
      });
      return response.data;
    } catch (error) {
...
postComment: async (blogId, commentData) => {
    const response = await axios.post(`${API_BASE_URL}/api/v1/blog/${blogId}/comments`, commentData, {
      headers: {
